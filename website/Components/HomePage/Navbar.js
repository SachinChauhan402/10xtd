        ...
        <div className="md:flex flex-col justify-center pr-4 hidden">
          <div className="flex justify-between text-base">
            ...
            {showGlobal && (
              ...
              >
                <div className="flex flex-col bg-white text-left w-96">
                  <a href="/cxos" target="_blank" rel="noreferrer ">
                    <div className="hover:text-blue-500 font-medium cursor-pointer py-2 w-full py-2 text-left mx-2 text-blue-450">
                  ...
                  <a href="/teams" target="_blank" rel="noreferrer ">
                    <div className="hover:text-blue-500 font-medium cursor-pointer py-2 w-full py-2 text-left mx-2 text-blue-450">
                      Global Partner Program for Partner Teams & Independent
                      Experts
                    </div>
                  </a>
                </div>
